"""
This is a template for an ETL process.
...
def load(ldf):
    ...
    try:
        for index, row in ldf.iterrows():
            query = """INSERT OR REPLACE INTO {0}(id,fname,lname,address) VALUES('{1}','{2}','{3}','{4}')"""\
                .format(JobConfig['TgtObject'],row['ID'],row['fname'],row['lname'],row['ADDRESS'])
